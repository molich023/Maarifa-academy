...
1. Push `futureminds/` to a GitHub repo:
   ```bash
   git init && git add . && git commit -m "FutureMinds Academy"
   git remote add origin https://github.com/molich023/futureminds.git
...
3. Set **Site URL** to your Netlify URL (e.g. `https://futureminds.netlify.app`)
...
## 📞 Contact Information
- **Phone:** 0736-340024
- **Email:** info@futuremindsacademy.co.ke
- **GitHub:** github.com/molich023/futureminds
...
| Admin | admin@futuremindsacademy.co.ke | admin123 |

**Demo Certificate IDs (for verification page):**
- `FMA-2026-MSEXCE-A8K2P1` — Jane W., Excel, 88%
- `FMA-2026-DATABA-B9L3Q2` — Brian K., SQL, 92%
- `FMA-2026-PYTHON-C7M4R3` — Brian K., Python, 74%
